...
def is_internet():
    ...
    try:
        ...
        if response.status_code == 204:
            ...
            print("internet status: portal")

        else:
            print("internet status: offline")
    except:
        print("internet status: error")

    return ret


def get_connection(www=False):
    """return a working WLAN(STA_IF) instance or None
        ha www=True akkor csak internet kapcsolatos hálózattal tér vissza
    """
